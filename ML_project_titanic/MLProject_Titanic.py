...
# STEP-2) Read in and Explore the Data ********************************************* It's time to read in our
# training and testing data using pd.read_csv, and take a first look at the training data using the describe()
# function.
...
# print(" percentages of females vs. males that survive") print( "Percentage of females who survived:",
